...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'grails3_1.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'grails3_1.UserRole'
grails.plugin.springsecurity.authority.className = 'grails3_1.Role'
